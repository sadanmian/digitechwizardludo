...
function App() {
  ...
  function updateScore(id, nb) {
    ...
    if (player === 1) {
      ...
      setScore2(
        Math.floor(
          ((new_scores[4] + new_scores[5] + new_scores[6] + new_scores[7]) *
            100) /
            248
        )
      );
      ...
      setScore3(
        Math.floor(
          ((new_scores[8] + new_scores[9] + new_scores[10] + new_scores[11]) *
            100) /
            248
        )
      );
      ...
      setScore4(
        Math.floor(
          ((new_scores[12] + new_scores[13] + new_scores[14] + new_scores[15]) *
            100) /
            248
        )
      );
          ...
          <div className="control-1">
            <div className="control-player">
              ...
              <div className="dashboard">
                ...
                {player !== 1 && (
                  <div className="de" onClick={() => play(1)}>
                    {winners.length > 0 && winners[0] === 1 && (
                      <img
                        alt=""
                        src={winner1}
                        style={{
                          width: "calc(((100vw - 137vh)/4) - 12px)",
                          height: "auto",
                          margin: "0",
                        }}
                      />
                    )}
                    {winners.length > 1 && winners[1] === 1 && (
                      <img
                        alt=""
                        src={winner2}
                        style={{
